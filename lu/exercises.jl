...
print("选列主元的结果:\n")
@show x1_with_selection =LU.lu_solver(A1, b1, true)
print("\n")

print("不选列主元的结果:\n")
@show x1_without_selection = LU.lu_solver(A1, b1, false)
print("\n")
...
print("改进的平方根法的结果:\n")
@show x2_ldlt = LU.sqroot_solver(A2, b2, true)
@show b2-A2*x2_ldlt
print("\n")

print("平方根法的结果:\n")
@show x2_chol = LU.sqroot_solver(A2, b2, false)
@show b2-A2*x2_chol
print("\n")
...
print("改进的平方根法的结果:\n")
@show x3_ldlt = LU.sqroot_solver(A3, b3, true)
@show b3-A3*x3_ldlt
print("\n")

print("平方根法的结果:\n")
@show x3_chol = LU.sqroot_solver(A3, b3, false)
@show b3-A3*x3_chol
print("\n")